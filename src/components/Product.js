...
function Product({id, title, price, description, image, shipping, colors}) {
    const MAX_RATING = 5
    const MIN_RATING = 1
    ...
    return (
        ...
        <Link href={`/product/${id}`}>
            <div className={"relative flex flex-col m-5 bg-white z-30 p-8 rounded-xl " + styles.loop_product}>
                ...
                <Image className={"rounded-lg " + styles.loop_product_image} loading="lazy" src={image} width={500} height={400} objectFit="cover" />
